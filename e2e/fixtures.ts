...
export const USERS = {
	primary: { email: "[user@example.com]", role: "[Role Name]", state: "e2e/.auth/primary.json" },
	restricted: { email: "[other@example.com]", role: "[Role Name]", state: "e2e/.auth/restricted.json" },
} as const;
